...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "karthik@gmail.com", "Karthik", "", "Dilshuknagar", "9876543210", "Hyderabad");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "koushik@gmail.com", "Koushik", "G", "Housing Board Colony", "7654321098", "Hyderabad");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "madhav@gmail.com", "Madhav", "A", "Kukatpally", "8765432190", "Hyderabad");
			user3.setRole("ROLE_USER");	
			User user4 = new User("aniemies", pwEncoder.encode("test"), "bharath@gmail.com", "Bharath", "K", "KPHB", "9834671234", "Hyderabad");
